...
$id = getGet('id');
$product = executeResult('SELECT * FROM products where product_id = '.$product_id, true);
?>
<!-- body START -->
<div class="row">
	<div class="col-md-5">
	...
	<div class="col-md-7">
		...
		<a href="checkout.php">
			<button class="btn btn-danger" style="width: 100%; font-size: 26px; margin-top: 10px;">Thanh Toán</button>
		</a>
	</div>
	<div class="col-md-12">
		<?=$product['content']?>
